...
void query_search(unsigned long long account_no);
...
void query_search(unsigned long long account_no)
{
    ...
    int num_acc;
    load(accounts, &num_acc);  //loads accounts
    int low = 0, mid = (num_acc-1) / 2, high = num_acc-1;
    int found = 0;
    ...
    /*{
        printf("Account Number: %llu\n", accounts[mid]->account_no);
        printf("Name: %s\n", accounts[mid]->name);
        printf("E-mail: %s\n", accounts[mid]->email);
        printf("Balance: %lf $\n", accounts[mid]->balance);
        printf("Mobile: %s\n", accounts[mid]->phone);
        printf("Date opened: ");
        switch (accounts[mid]->date_opened.month)
        {
        ...
        printf(" %d", accounts[mid]->date_opened.year);
    }*/
    unload(accounts, num_acc);  //unloads accounts
}
